...
public class AddVersionView3 extends JFrame implements ActionListener {
	...
	public AddVersionView3(ArrayList<String> cName, ArrayList<Integer> rvNum) {
...
//		}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == nextBtn){
			...
			MainSystem.gm.addVersionView4(rvName, constNum);
			...
			this.dispose();
			MainSystem.gm.addVersionFrame2.setVisible(true);
		}
